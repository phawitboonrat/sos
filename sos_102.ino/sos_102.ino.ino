/* Emergency SOS
1.gennerrate LINE_TOKEN   name:     ⚠️เกิดเหตุการณ์⚠️:        forGroup: SOS-setA    "2Mn7WJL0LBUWXUiESf4nwK22BefRNRfAsQjU7VzI4lW"
             LINE_TOKENX  name:     ⚠️SOS:             forGroup: SOS-setA    "d0TjmMatZBioTIRy7ukXJK9daYuLZQEUy9twIJnIXtb"
2.Edit #define LINE_TOKEN , #define LINE_TOKENX
3.Replace A 01 with spacific id
  ex. for SetA : A 01,A 02,A 03,...
      for SetB : B 01,B 02,B 03,...
*/
...
#define SW D3
//B01
#define LINE_TOKEN "2Mn7WJL0LBUWXUiESf4nwK22BefRNRfAsQjU7VzI4lW"  //line: EmergencySOS-B01   ⚠️เกิดเหตุการณ์⚠️:
#define LINE_TOKENX "d0TjmMatZBioTIRy7ukXJK9daYuLZQEUy9twIJnIXtb"        // for setup and update   line: EmergencySOS-B01      ⚠️SOS:
...
//  wifiManager.resetSettings();
  ...
  wifiManager.autoConnect("EmergencySOS-B01");
  
  if (!wifiManager.autoConnect("EmergencySOS-B01")) {
    Serial.println("failed to connect and hit timeout");
    ESP.reset();
    delay(1000);
  }
  Serial.println("connected...yeey :)");
  Line_NotifyX("EmergencySOS-B01 : Online\nPress button 3 sec for setup!");
  delay(2000);
  ticker.detach();
...
//    Line_NotifyX("EmergencySOS-B01 : OFFline");
    while(WiFi.status() != WL_CONNECTED){
